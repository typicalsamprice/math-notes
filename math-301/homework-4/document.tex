        ...
        \begin{enumerate}
          ...
          \item Prove $h$ is discontinuous at $x = 0$.
                ...
                \begin{proof}
                  ...
                  \[ a_{n} = \begin{cases}
                    \frac{1}{k} & \text{$n = 2k$ for some $k \in \N$}\\
                    -\frac{1}{k} & \text{$n = 2k + 1$ for some $k \in \N$}
                  \end{cases} \]
                It should be clear that $h(a_{n}) = \sin(\Z \setminus \set{0})$ and that $a_{n} \to 0$.
                By Lemma~\ref{lem:sin-dense}, $\sin \Z$ is dense, and so $h(a_{n})$ (as a whole sequence) is dense as well.
                ...
                Since $M$ is finite, so must $S$ be too (and we know it is nonempty as well $\sin(1/2) > \sin(1/4) > 1/10$.)
