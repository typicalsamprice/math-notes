...
\begin{theorem}[Riemann Rearrangement Theorem]\label{thm:riemann-rearrangement}
...
\begin{theorem}[Union of Closed Sets]\label{thm:union-closed-sets}
...
\begin{theorem}[Closed iff contains limit points]\label{defn:closed-iff-limit-points}
...
\begin{defn}[Riemann Sum with Partition]
...
\begin{defn}[Riemann-Darboux Integral]
  Define the sums
